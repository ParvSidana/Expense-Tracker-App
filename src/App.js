...
function App() {
  ...
  const fetchTransactions = async () => {
    try {
      const res = await fetch(`${process.env.REACT_APP_APP_URL}/transactions`); //get req
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch(`${process.env.REACT_APP_APP_URL}/transaction`, {
        method: "POST",
        headers: {
  ...
  const deleteTransaction = async (transactionId) => {
    ...
    try {
      const res = await fetch(
        `${process.env.REACT_APP_APP_URL}/transaction/${transactionId}`,
        {
          method: "DELETE",
          headers: {
            "Content-Type": "application/json",
